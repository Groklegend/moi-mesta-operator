...
begin
  ...
  insert into motivation_entries (
    ...
    (op_id, '2026-04-03', NULL,   0, 30,    0,  NULL, 100,   0, NULL, NULL, 500,    0, NULL, NULL, 3000, 0,    0),
    -- Выходные 04-05.04 — шаблонные строки с дефолтными ценами и нулевыми суммами
    (op_id, '2026-04-04', NULL, NULL, 30,    0,  NULL, 100,   0, NULL, NULL, 500,    0, NULL, NULL, 3000, 0,    0),
    (op_id, '2026-04-05', NULL, NULL, 30,    0,  NULL, 100,   0, NULL, NULL, 500,    0, NULL, NULL, 3000, 0,    0),
    ...
    (op_id, '2026-04-09', NULL,   0, 30,    0,  NULL, 100,   0, NULL,    1, 500,  500, NULL, NULL, 3000, 0,  500),
    (op_id, '2026-04-10',  55,   30, 30,  900,     1, 100, 100, NULL, NULL, 500,    0, NULL, NULL, 3000, 0, 1000),
    -- Выходные 11-12.04 — шаблонные строки
    (op_id, '2026-04-11', NULL, NULL, 30,    0,  NULL, 100,   0, NULL, NULL, 500,    0, NULL, NULL, 3000, 0,    0),
    (op_id, '2026-04-12', NULL, NULL, 30,    0,  NULL, 100,   0, NULL, NULL, 500,    0, NULL, NULL, 3000, 0,    0),
    (op_id, '2026-04-13', NULL,   0, 30,    0,  NULL, 100,   0, NULL, NULL, 500,    0, NULL, NULL, 3000, 0,    0),
    ...
    (op_id, '2026-04-16', 103,   41, 30, 1230,  NULL, 100,   0, NULL,    2, 500, 1000, NULL, NULL, 3000, 0, 2230),
    (op_id, '2026-04-17', NULL,  50, 40, 2000,     2, 100, 200, NULL, NULL, 500,    0, NULL, NULL, 3000, 0, 2200)
  ...
  raise notice 'Мотивация Елены за апрель 2026: 17 строк (01-17.04) залиты/обновлены.';
end$$;
